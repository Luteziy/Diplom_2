...
class TestCreateOrders:
    ...
    def test_create_order_loged_in(self, create_user_delete_user):
        ...
        response = requests.post(Data.Url_create_and_get_order, data=burg, headers=headers)
    ...
    def test_create_order_without_login(self):
        burg = {'ingredients': [BurgerIngred.burg_0]}
        response = requests.post(Data.Url_create_and_get_order, data=burg, headers=Data.headers)
